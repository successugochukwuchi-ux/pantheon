                  ...
                  >
                    ...
                    <div className="space-y-4 pt-2">
                      ...
                      <div className="relative flex py-2 items-center w-full">
                        ...
                        <span className="flex-shrink mx-4 text-muted-foreground text-[10px] uppercase font-bold tracking-wider">Or register in 1-click</span>
                        <div className="flex-grow border-t border-muted-foreground/15"></div>
                      </div>
                      ...
                      <Button 
                        type="button"
                        variant="outline"
                        className="w-full h-12 rounded-2xl flex items-center justify-center gap-2 border-border hover:bg-muted/50 cursor-pointer font-bold text-sm shadow-sm"
